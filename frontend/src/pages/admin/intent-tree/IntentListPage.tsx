...
const FILTER_SELECT_TRIGGER_CLASS =
  "h-10 text-sm border-stone-200 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0 data-[state=open]:border-stone-200 data-[state=open]:ring-0";
const FILTER_INPUT_CLASS =
  "h-10 border-stone-200 pl-10 text-sm focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-stone-200";
        ...
        <div className="rounded-xl border border-stone-200 bg-white p-3">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button
                variant="outline"
                className="h-10 gap-1.5 border-stone-200 px-3 text-sm"
      ...
      <Card className="overflow-hidden">
        <CardContent className="space-y-3 pt-4">
          {selectedRows.length > 0 ? (
            <div className="-mx-6">
              <div className="flex flex-wrap items-center justify-between gap-2 rounded-none border-y border-stone-200/80 bg-stone-50 px-6 py-2">
                <span className="text-sm font-medium text-stone-700">已选 {selectedRows.length} 项</span>
                <div className="flex flex-wrap items-center gap-2">
                  <Button
                    size="sm"
                    variant="outline"
            ...
            <Table className="min-w-[1280px] [&_th]:h-10 [&_th]:py-2 [&_td]:py-2">
              ...
              <TableBody>
                {pageRows.map((row) => (
                  <TableRow
                    key={row.id}
                    className="group text-[13px] hover:!bg-stone-50"
                  >
                    <TableCell>
                      <Checkbox
                    ...
                    <TableCell>
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="rounded-full border border-stone-200 bg-stone-50 px-2 py-0.5 font-mono text-xs text-stone-600">
                            {row.intentCode}
                          </span>
                        </div>
                      </div>
                            ...
                            <button
                              ...
                              className={cn(
                                ...
                                index === row.pathNames.length - 1
                                  ? "bg-stone-100 text-stone-600 font-medium hover:bg-stone-200"
                    ...
                    <TableCell>
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-stone-400">TopK: {row.topK ?? "全局默认"}</p>
                      </div>
                    </TableCell>
                    <TableCell>
                      <span className="font-medium text-stone-700">{row.exampleCount}</span>
                    </TableCell>
                    <TableCell>
                      <Badge
                    ...
                    <TableCell
                      className="sticky right-0 z-10 bg-white shadow-[-1px_0_0_rgba(226,232,240,1)] group-hover:bg-stone-50"
                    >
                      <div className="flex items-center gap-2">
                        <Button
                          size="sm"
