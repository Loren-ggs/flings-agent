...
export const nodeTypeChipClass = (type?: string | null): string => {
  ...
  if (normalized === "ROOT") return "bg-orange-100 text-orange-700";
  if (normalized === "AGENT") return "bg-fuchsia-100 text-fuchsia-700";
  ...
  if (normalized === "INTENT") return "bg-orange-100 text-orange-700";
  if (normalized === "REWRITE") return "bg-teal-100 text-teal-700";
  if (normalized === "RETRIEVE" || normalized === "RAG_NODE") return "bg-orange-100 text-orange-700";
