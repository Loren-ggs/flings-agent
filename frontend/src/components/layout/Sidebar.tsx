...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const avatarFallback = getEmojiAvatar(user?.userId || user?.username);
        ...
        <div className="border-b border-[#F0F0F0] pb-3">
          <div className="flex items-center gap-3">
            ...
            <div style={{ fontFamily: sessionTitleFont }}>
              <p className="text-base font-semibold text-[#1A1A1A]">Flingsagent AI 智能体</p>
              <p className="text-xs text-[#999999]">Powered by AI</p>
            </div>
          </div>
        </div>
        <div className="py-3 space-y-4">
          <div className="relative overflow-hidden rounded-2xl border border-[#F5E9DC] bg-gradient-to-br from-[#FFF7ED] via-white to-[#FEF3C7] p-3 shadow-[0_14px_30px_rgba(15,23,42,0.08)]">
            <span
              aria-hidden="true"
              className="absolute -right-10 -top-10 h-24 w-24 rounded-full bg-[#FED7AA]/70 blur-2xl"
            />
            <span
              aria-hidden="true"
            ...
            <div className="relative">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="rounded-full bg-white/80 px-2 py-0.5 text-[10px] font-semibold text-[#EA580C]">
                  新内容
                </span>
              </div>
              <button
              ...
              >
                <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[#FB923C] to-[#EA580C] text-white shadow-[0_6px_14px_rgba(37,99,235,0.3)]">
          ...
          <div className="rounded-2xl border border-[#F5E9DC] bg-white p-3 shadow-[0_12px_26px_rgba(15,23,42,0.06)]">
            <div className="flex items-center justify-between px-1">
              <span className="text-[11px] font-semibold text-[#94A3B8]">搜索对话</span>
              <span className="text-[10px] text-[#FDBA74]">Ctrl / Cmd + K</span>
            </div>
            <div className="mt-2">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="搜索对话..."
                  className="h-10 w-full rounded-xl border border-[#E5E7EB] bg-[#F8FAFC] pl-9 pr-3 text-sm text-[#1F2937] placeholder:text-[#9CA3AF] focus:border-[#FDBA74] focus:outline-none transition-colors"
                />
              </div>
            </div>
          </div>
                      ...
                      >
                        {renamingId === session.id ? (
                          <input
                            ...
                            className="h-6 flex-1 rounded-md border border-[#E5E5E5] bg-white px-2 text-[14px] leading-[22px] text-[#333333] focus:border-[#EA580C] focus:outline-none"
                          />
                        ) : (
                          ...
                          <DropdownMenuTrigger asChild>
                            <button
                              ...
                              className={cn(
                                ...
                                currentSessionId === session.id
                                  ? "pointer-events-auto opacity-100 text-[#EA580C]"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                ...
                aria-label="用户菜单"
              >
                <div className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-[#FFEDD5] text-base">
                  {showAvatar ? (
                    <img
                      src={avatarUrl}
                    ...
                    <span className="text-base leading-none">{avatarFallback}</span>
                  )}
                </div>
