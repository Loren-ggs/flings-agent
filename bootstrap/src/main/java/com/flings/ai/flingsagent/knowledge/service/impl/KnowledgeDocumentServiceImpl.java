...
package com.flings.ai.flingsagent.knowledge.service.impl;
...
import com.flings.ai.flingsagent.core.chunk.ChunkEmbeddingService;
import com.flings.ai.flingsagent.core.chunk.ChunkingMode;
import com.flings.ai.flingsagent.core.chunk.ChunkingOptions;
import com.flings.ai.flingsagent.core.chunk.ChunkingStrategy;
import com.flings.ai.flingsagent.core.chunk.ChunkingStrategyFactory;
import com.flings.ai.flingsagent.core.chunk.VectorChunk;
import com.flings.ai.flingsagent.core.parser.DocumentParserSelector;
import com.flings.ai.flingsagent.core.parser.ParserType;
import com.flings.ai.flingsagent.framework.context.UserContext;
import com.flings.ai.flingsagent.framework.exception.ClientException;
import com.flings.ai.flingsagent.framework.mq.producer.MessageQueueProducer;
import com.flings.ai.flingsagent.ingestion.dao.entity.IngestionPipelineDO;
import com.flings.ai.flingsagent.ingestion.dao.mapper.IngestionPipelineMapper;
import com.flings.ai.flingsagent.ingestion.domain.context.IngestionContext;
import com.flings.ai.flingsagent.ingestion.domain.pipeline.PipelineDefinition;
import com.flings.ai.flingsagent.ingestion.engine.IngestionEngine;
import com.flings.ai.flingsagent.ingestion.service.IngestionPipelineService;
import com.flings.ai.flingsagent.knowledge.config.KnowledgeScheduleProperties;
import com.flings.ai.flingsagent.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.flings.ai.flingsagent.knowledge.controller.request.KnowledgeDocumentPageRequest;
import com.flings.ai.flingsagent.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.flings.ai.flingsagent.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.flings.ai.flingsagent.knowledge.controller.vo.KnowledgeChunkVO;
import com.flings.ai.flingsagent.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.flings.ai.flingsagent.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.flings.ai.flingsagent.knowledge.controller.vo.KnowledgeDocumentVO;
import com.flings.ai.flingsagent.knowledge.dao.entity.KnowledgeBaseDO;
import com.flings.ai.flingsagent.knowledge.dao.entity.KnowledgeChunkDO;
import com.flings.ai.flingsagent.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
import com.flings.ai.flingsagent.knowledge.dao.entity.KnowledgeDocumentDO;
import com.flings.ai.flingsagent.knowledge.dao.mapper.KnowledgeBaseMapper;
import com.flings.ai.flingsagent.knowledge.dao.mapper.KnowledgeChunkMapper;
import com.flings.ai.flingsagent.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
import com.flings.ai.flingsagent.knowledge.dao.mapper.KnowledgeDocumentMapper;
import com.flings.ai.flingsagent.knowledge.enums.DocumentStatus;
import com.flings.ai.flingsagent.knowledge.enums.ProcessMode;
import com.flings.ai.flingsagent.knowledge.enums.SourceType;
import com.flings.ai.flingsagent.knowledge.handler.RemoteFileFetcher;
import com.flings.ai.flingsagent.knowledge.mq.event.KnowledgeDocumentChunkEvent;
import com.flings.ai.flingsagent.knowledge.schedule.CronScheduleHelper;
import com.flings.ai.flingsagent.knowledge.service.KnowledgeChunkService;
import com.flings.ai.flingsagent.knowledge.service.KnowledgeDocumentScheduleService;
import com.flings.ai.flingsagent.knowledge.service.KnowledgeDocumentService;
import com.flings.ai.flingsagent.rag.core.vector.VectorSpaceId;
import com.flings.ai.flingsagent.rag.core.vector.VectorStoreService;
import com.flings.ai.flingsagent.rag.dto.StoredFileDTO;
import com.flings.ai.flingsagent.rag.service.FileStorageService;
